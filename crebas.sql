...
/* Created on:     21.01.2024 13:12:11                          */
/*==============================================================*/
...
create table DIAGNOSE (
   ...
   STATUS2              NUMBER(1,0)          default 1  not null
      constraint CKC_STATUS2_DIAGNOSE check (STATUS2 between 0 and 1),
...
comment on column DIAGNOSE.STATUS2 is
...
comment on column KRANKENHAUS.NAME2 is
...
create table LAGERRAUM (
   ...
   constraint PK_LAGERRAUM primary key (RAUM_ID)
)
/

comment on column LAGERRAUM.RAUM_ID is
'Primärschlüssel'
/
...
create table OPERATIONSSAAL (
   ...
   constraint PK_OPERATIONSSAAL primary key (RAUM_ID)
)
/

comment on column OPERATIONSSAAL.RAUM_ID is
'Primärschlüssel'
/
...
comment on column PATIENT.NAME4 is
...
create table PATIENTENRAUM (
   ...
   constraint PK_PATIENTENRAUM primary key (RAUM_ID)
)
/

comment on column PATIENTENRAUM.RAUM_ID is
'Primärschlüssel'
/
